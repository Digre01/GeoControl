...
/**
 * Check if a given object implements the Measurements interface.
 */
export function instanceOfMeasurements(value: object): value is Measurements {
    if (!('sensorMacAddress' in value) || value['sensorMacAddress'] === undefined) return false;
    return true;
}
...
export function MeasurementsFromJSONTyped(json: any, ignoreDiscriminator: boolean): Measurements {
    ...
    return {
        ...
        'sensorMacAddress': json['sensorMacAddress'],
        'stats': json['stats'] == null ? undefined : StatsFromJSON(json['stats']),
        'measurements': json['measurements'] == null ? undefined : ((json['measurements'] as Array<any>).map(MeasurementFromJSON)),
    };
}

export function MeasurementsToJSON(json: any): Measurements {
    return MeasurementsToJSONTyped(json, false);
}

export function MeasurementsToJSONTyped(value?: Measurements | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'sensorMacAddress': value['sensorMacAddress'],
        'stats': StatsToJSON(value['stats']),
        'measurements': value['measurements'] == null ? undefined : ((value['measurements'] as Array<any>).map(MeasurementToJSON)),
    };
}
