...
import { validatorHandler } from "@middlewares/validatorMiddleware";
//import { customEndDateParser, customSensorMacsParser, customStartDateParser } from "@middlewares/customParserMiddleware";
...
//app.use(customSensorMacsParser);
//app.use(customStartDateParser);
//app.use(customEndDateParser);
